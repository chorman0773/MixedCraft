...
public class ModelSheep2 extends ModelQuadruped
{
    ...
    public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4)
    {
        ...
        this.head.rotationPointY = 6.0F + ((EntityCowSheep)par1EntityLiving).func_70894_j(par4) * 9.0F;
        this.field_78153_i = ((EntityCowSheep)par1EntityLiving).func_70890_k(par4);
    }

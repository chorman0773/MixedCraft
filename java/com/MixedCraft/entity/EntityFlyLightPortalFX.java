...
public class EntityFlyLightPortalFX extends EntityFX
{
    ...
    public EntityFlyLightPortalFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {

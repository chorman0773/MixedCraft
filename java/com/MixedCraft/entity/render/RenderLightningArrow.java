...
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("MixedCraft:textures/items/LightningArrows.png");
    ...
    public void renderArrow(EntityLightningArrow par1EntityLightningArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        float f11 = (float)par1EntityLightningArrow.arrowShake - par9;

...
public class RenderTNTArrow extends Render
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("MixedCraft:textures/items/TNTArrows.png");
    ...
    public void renderArrow(EntityTNTArrow par1EntityTNTArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glRotatef(par1EntityTNTArrow.prevRotationPitch + (par1EntityTNTArrow.rotationPitch - par1EntityTNTArrow.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float f11 = (float)par1EntityTNTArrow.arrowShake - par9;

...
{
    private TileEntityDiamondFurnace furnaceInventory;

    public GuiDiamondFurnace(InventoryPlayer par1InventoryPlayer, TileEntityDiamondFurnace par2TileEntityFurnace)
    {
        super(new ContainerDiamondFurnace(par1InventoryPlayer, par2TileEntityFurnace));
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.getTextureManager().bindTexture(GuiResourceLocation.DiamondFurnace);

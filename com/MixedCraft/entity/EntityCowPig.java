...
public class EntityCowPig extends EntityAnimal
{
    ...
    /**
     * returns true if all the conditions for steering the entity are met. For CowPigs, this is true if it is being ridden
    ...
    /**
     * Called when a player interacts with a mob. e.g. gets milk from a cow, gets into the saddle on a CowPig.
     */
    ...
    /**
     * Returns true if the CowPig is saddled.
     */
    ...
    /**
     * Set or remove the saddle of the CowPig.
     */
     ...
     */
    public EntityCowPig spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityCowPig(this.worldObj);
    }

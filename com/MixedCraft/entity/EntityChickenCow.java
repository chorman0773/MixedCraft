...
public class EntityChickenCow extends EntityAnimal
{
    ...
    public EntityChickenCow(World par1World)
    {
        super(par1World);
     ...
     */
    public EntityChickenCow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        return new EntityChickenCow(this.worldObj);
    }

...
import com.MixedCraft.helper.MobRegistry;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EntityLightningArrow extends Entity implements IProjectile
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityLightningArrow(World par1World)
	{
		super(par1World);
	...
	public EntityLightningArrow(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public void onImpact(MovingObjectPosition par1MovingObjectPosition, World world, EntityPlayer player)
	{
		...
		if (movingobjectposition.entityHit != null)
		{
			...
			world.spawnEntityInWorld(new EntityLightningBolt(world, b, r, o));
		...
		public EntityLightningArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
		{
			super(par1World);
			this.renderDistanceWeight = 10.0D;
		...
		public EntityLightningArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
		{
			super(par1World);
			this.renderDistanceWeight = 10.0D;
			this.shootingEntity = par2EntityLivingBase;
		 ...
		 public void setThrowableHeading(double par1, double par3, double par5, float par7, float par8)
		{
			 ...
			 else
			 {
				 ...
				 if (movingobjectposition != null)
				 {
					 if (movingobjectposition.entityHit != null)
					 {
						 ...
						 {
							 damagesource = MobRegistry.causeLightningDamage(this, this);
						 }
						 else
						 {
							 damagesource = MobRegistry.causeLightningDamage(this, this.shootingEntity);
						 }
						 ...
						 if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
						 {
							 ...
							 if (movingobjectposition.entityHit != null)
							 {
								 ...
								 this.setDead();
								// this.onImpact(movingobjectposition, worldObj, entityplayer);
							 }
						 }
						 else
						 {
		 ...
		 public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
		 {
			 if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
			 {
				 ...
				 if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ItemHelper.LightningArrow, 1)))
				 {
					 flag = false;
				 }

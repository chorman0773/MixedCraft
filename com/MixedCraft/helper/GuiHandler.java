...
public class GuiHandler implements IGuiHandler {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(entity instanceof TileEntityDNAExtractor){
			return new GuiDNAExtractor(player.inventory, (TileEntityDNAExtractor) world.getBlockTileEntity(x, y, z));
		}
		
		if(entity instanceof TileEntityDNAMixer){
			return new GuiDNAMixer(player.inventory, (TileEntityDNAMixer) world.getBlockTileEntity(x, y, z));
		}
		
		if(entity instanceof TileEntityDNAAssembler){
			return new GuiMobAssembler(player.inventory, (TileEntityDNAAssembler) world.getBlockTileEntity(x, y, z));
		}
		
		if(entity instanceof TileEntityDisasembler){
			return new GuiDisasembler(player.inventory, (TileEntityDisasembler) world.getBlockTileEntity(x, y, z));
		}
		
		if(entity instanceof TileEntityIronFurnace){
			return new GuiIronFurnace(player.inventory, (TileEntityIronFurnace) world.getBlockTileEntity(x, y, z));
		}
		...
		case 4: return new GuiBlazeDNA(new DNAContainer());
		case 5: return new GuiChickenDNA(new DNAContainer());
		case 6: return new GuiCreeperDNA(new DNAContainer());
		case 7: return new GuiEndermanDNA(new DNAContainer());
		case 8: return new GuiGhastDNA(new DNAContainer());
		case 9: return new GuiSheepDNA(new DNAContainer());
		case 10: return new GuiSkeletonDNA(new DNAContainer());
		case 11: return new GuiSlimeDNA(new DNAContainer());
		case 12: return new GuiSpiderDNA(new DNAContainer());
		case 13: return new GuiSquidDNA(new DNAContainer());

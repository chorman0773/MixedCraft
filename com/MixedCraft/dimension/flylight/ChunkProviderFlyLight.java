...
import com.MixedCraft.dimension.WorldGenDimensionMineable;

public class ChunkProviderFlyLight implements IChunkProvider
{
    private Random rand;
    ...
    public ChunkProviderFlyLight(World var1, long var2, boolean var4)
    {
        this.worldObj = var1;
    ...
    public void replaceBlocksForBiome(int var1, int var2, byte[] var3, BiomeGenBase[] var4)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                byte var15 = (byte)BlockHelper.FlyLightGrass.blockID;
                    ...
                    else
                    {
                        ...
                        else if (var18 == Block.stone.blockID)
                        {
                            if (var13 == -1)
                            {
                                if (var12 <= 0)
                                {
                                    var14 = (byte)BlockHelper.FlyLightGrass.blockID;
                                    var15 = (byte)BlockHelper.FlyLightGrass.blockID;
                                }
                            ...
                            else if (var13 > 0)
                            {
                                ...
                                if (var13 == 0 && var15 == BlockHelper.FlyLightGrass.blockID)
                                {
                                    var13 = (byte)BlockHelper.FlyLightGrass.blockID;
                                    var15 = (byte)BlockHelper.FlyLightGrass.blockID;
                                }
                            }
                        }
                        ...
                        if (var13 > 0)
                        {
                            ...
                            if (var13 == 0 && var15 == BlockHelper.FlyLightStone.blockID)
                            {
                                var13 = (byte)BlockHelper.FlyLightGrass.blockID;
                                var15 = (byte)BlockHelper.FlyLightStone.blockID;
                            }
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        for (var13 = 0; var13 < 15; ++var13)
        {
            ...
            (new WorldGenDimensionMineable(BlockHelper.FlyLightOre.blockID, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
        }

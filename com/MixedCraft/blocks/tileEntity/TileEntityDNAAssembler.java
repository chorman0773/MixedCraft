...
import com.MixedCraft.recipes.AssemblerRecipes;

import cpw.mods.fml.common.registry.GameRegistry;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class TileEntityDNAAssembler extends TileEntityFurnace implements IInventory
{
    /**
    ...
    public int furnaceBurnTime = 900000000;
    ...
    public int furnaceCookTime = 700;
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                BlockMobAssembler.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = AssemblerRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);

...
{
    private TileEntityDiamondFurnace furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerDiamondFurnace(InventoryPlayer par1InventoryPlayer, TileEntityDiamondFurnace par2TileEntityFurnace)
    {

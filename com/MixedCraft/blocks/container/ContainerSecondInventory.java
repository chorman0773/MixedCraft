...
public class ContainerSecondInventory extends Container
{
    ...
    public ContainerSecondInventory(InventoryPlayer par1InventoryPlayer, boolean par2, EntityPlayer par3EntityPlayer)
    {

...
public class BlockPoweredFurnace extends BlockContainer
{
    ...
    private Icon PowerFurnaceIconTop;
    @SideOnly(Side.CLIENT)
    private Icon PowerFurnaceIconFront;
    ...
    public int idDropped(int par1, Random par2Random, int par3) {
        return BlockHelper.PoweredFurnace.blockID;
    }
    ...
    public Icon getIcon(int par1, int par2)  {
        return par1 == 1 ? this.PowerFurnaceIconTop : (par1 == 0 ? this.PowerFurnaceIconTop : (par1 != par2 ? this.blockIcon : this.PowerFurnaceIconFront));
    }

    @SideOnly(Side.CLIENT)
    public void registerIcons(IconRegister par1IconRegister) {
        this.blockIcon = par1IconRegister.registerIcon("MixedCraft:PowerFurnace");
        this.PowerFurnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "MixedCraft:PowerFurnaceFront_On" : "MixedCraft:PowerFurnaceFront_Off");
        this.PowerFurnaceIconTop = par1IconRegister.registerIcon("MixedCraft:PowerFurnace");
    }
    ...
    public static void updatePowerFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, BlockHelper.PoweredFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, BlockHelper.PoweredFurnace.blockID);
        }

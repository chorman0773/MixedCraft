...
public class BiggerCraftingTable extends BlocksBase{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("MixedCraft:BigSide");
		this.workbenchIconTop = par1IconRegister.registerIcon("MixedCraft:BigTop");
		this.workbenchIconFront = par1IconRegister.registerIcon("MixedCraft:BigFront");
	}

...
import com.MixedCraft.dimension.flylight.TeleporterFlyLight;
import com.MixedCraft.entity.EntityFlyLightPortalFX;
...
public class FlyLightPortal extends BreakableBase
{

    public FlyLightPortal(int par1)
    {
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
        {
            ...
            else if (thePlayer.dimension != DimensionHelper.FlyLightID)
            {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionHelper.FlyLightID, new TeleporterFlyLight(thePlayer.mcServer.worldServerForDimension(DimensionHelper.FlyLightID)));
            }
            else {
                thePlayer.timeUntilPortal = 10;
    ...
    public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        for (int var6 = 0; var6 < 4; ++var6)
        {
            ...
            EntityFlyLightPortalFX var20 = new EntityFlyLightPortalFX(var1, var7, var9, var11, var13, var15, var17);

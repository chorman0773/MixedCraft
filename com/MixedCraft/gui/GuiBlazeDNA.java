...
public class GuiBlazeDNA extends GuiBaseDNA{
	...
	{
		this.fontRenderer.drawString("BLAZE", 40 + 12, 20 - 33, 0xFFFFFF);
		
		this.fontRenderer.drawString("Monster", 40 + 16, 20 + 39, 0xFFFFFF);

		this.fontRenderer.drawString("Mob", 40 + 16, 20 + 56, 0xFFFFFF);
		
		this.fontRenderer.drawString("Blaze", 40 + 16, 20 + 71, 0xFFFFFF);

		this.fontRenderer.drawString("A Yellow flying creature that fires", 1 - 10, 20 + 129, 0xFFFFFF);
		this.fontRenderer.drawString("little charges that set you on fire.", 1 - 10, 20 + 139, 0xFFFFFF);
	}
}

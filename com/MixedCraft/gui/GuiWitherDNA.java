...
public class GuiWitherDNA extends GuiBaseDNA{
	...
	{
		this.fontRenderer.drawString("WITHER", 40 + 12, 20 - 33, 0xFFFFFF);
		
		this.fontRenderer.drawString("Monster", 40 + 16, 20 + 39, 0xFFFFFF);

		this.fontRenderer.drawString("Mob", 40 + 16, 20 + 56, 0xFFFFFF);
		
		this.fontRenderer.drawString("Wither", 40 + 16, 20 + 71, 0xFFFFFF);

		this.fontRenderer.drawString("A monster that kills everything", 1 - 10, 20 + 129, 0xFFFFFF);
		this.fontRenderer.drawString("around it.", 1 - 10, 20 + 139, 0xFFFFFF);

...
public class GuiCreeperDNA extends GuiBaseDNA{
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		this.fontRendererObj.drawString("CREEPER", 40 + 12, 20 - 33, 0xFFFFFF);
		
		this.fontRendererObj.drawString("Monster", 40 + 16, 20 + 39, 0xFFFFFF);

		this.fontRendererObj.drawString("Mob", 40 + 16, 20 + 56, 0xFFFFFF);
		
		this.fontRendererObj.drawString("Creeper", 40 + 16, 20 + 71, 0xFFFFFF);

		this.fontRendererObj.drawString("A little green monster that creeps", 1 - 10, 20 + 129, 0xFFFFFF);
		this.fontRendererObj.drawString("around and explodes.", 1 - 10, 20 + 139, 0xFFFFFF);
	}
}
...
import com.MixedCraft.blocks.container.ContainerDNAExtractor;
...
public class GuiDNAExtractor extends GuiContainer{
    ...
    private TileEntityDNAExtractor furnaceInventory;

	   public GuiDNAExtractor(InventoryPlayer var1, TileEntityDNAExtractor var2)
	    {
	        super(new ContainerDNAExtractor(var1, var2));
	   ...
	   protected void drawGuiContainerForegroundLayer(int par1, int par2)
	    {
	        this.fontRendererObj.drawString("DNA Extractor", 50, 6, 0xFFFFFF);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
		...
		this.mc.getTextureManager().bindTexture(GuiResourceLocation.Extractor);

...
public class RecipesIngots
{
    ...
    public void addRecipes(CraftingBigManager par1CraftingManager)
    {
        for (int i = 0; i < this.recipeItems.length; ++i)
        {
            ...
            par1CraftingManager.addShapedRecipe(new ItemStack(block), new Object[] {"###", "###", "###", '#', itemstack});
            par1CraftingManager.addShapedRecipe(itemstack, new Object[] {"#", '#', block});
        }

        par1CraftingManager.addShapedRecipe(new ItemStack(Item.ingotGold), new Object[] {"###", "###", "###", '#', Item.goldNugget});
        par1CraftingManager.addShapedRecipe(new ItemStack(Item.goldNugget, 9), new Object[] {"#", '#', Item.ingotGold});
    }
}

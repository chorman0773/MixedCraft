...
public class RecipesFood
{
    ...
    public void addRecipes(CraftingBigManager par1CraftingManager)
    {
        ...
        par1CraftingManager.addShapedRecipe(new ItemStack(Item.cookie, 8), new Object[] {"#X#", 'X', new ItemStack(Item.dyePowder, 1, 3), '#', Item.wheat});
        par1CraftingManager.addShapedRecipe(new ItemStack(Block.melon), new Object[] {"MMM", "MMM", "MMM", 'M', Item.melon});
        par1CraftingManager.addShapedRecipe(new ItemStack(Item.melonSeeds), new Object[] {"M", 'M', Item.melon});
        par1CraftingManager.addShapedRecipe(new ItemStack(Item.pumpkinSeeds, 4), new Object[] {"M", 'M', Block.pumpkin});

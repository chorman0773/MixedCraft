...
public class RecipeHelper {
	...
	public static void BigShapedCrafting(){
		...
		CraftingBigManager.getInstance().addShapedRecipe(new ItemStack(ItemHelper.CopperIngot, 1), new Object[] {"III", " I ", "III", " I ", "III", 'I', Item.ingotIron});
		...
		CraftingBigManager.getInstance().addShapedRecipe(new ItemStack(BlockHelper.TinBlock, 1), new Object[] {"   ", "III", "III", "III", "   ", 'I', ItemHelper.SilverIngot});
		CraftingBigManager.getInstance().addShapedRecipe(new ItemStack(BlockHelper.TinBlock, 1), new Object[] {"   ", "   ", "III", "III", "III", 'I', ItemHelper.SilverIngot});

...
import com.MixedCraft.entity.EntityModArrow;
...
public class ModReflectionHelper
{
    ...
    public static <T, E> T getPrivateValue(Class<EntityTNTArrow> class1, EntityModArrow entityModArrow, int fieldIndex)
    {
        try
        {
            Field f = class1.getDeclaredFields()[fieldIndex];
            f.setAccessible(true);
            return (T) f.get(entityModArrow);
        }
        catch (Exception e)
        {

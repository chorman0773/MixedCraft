...
public class WorldGenSandMinable extends WorldGenerator
{
    ...
    public WorldGenSandMinable(int par1, int par2)
    {
        this(par1, par2, Block.sand.blockID);
    }

    public WorldGenSandMinable(int par1, int par2, int par3)
    {
    ...
    public WorldGenSandMinable(int id, int meta, int number, int target)
    {
